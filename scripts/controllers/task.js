...
app.controller('TaskController', function($scope, $location, toaster, Task, Auth) {
	...
	$scope.createTask = function() {	
		...
		Task.createTask($scope.task).then(function(ref) {
			toaster.pop('success', 'Carpool Request created successfully.');
			$scope.task = {pickuptime: '', pickuplocation: '', destinationtime: '', destination: '', total: '', status: 'open', gravatar: '', name: '', poster: ''};
